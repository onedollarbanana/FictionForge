    ...
    <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex gap-1 flex-wrap">
            {sortOptions.map((option) => (
              <Link
                key={option.value}
                href={`/browse/tag/${encodeURIComponent(tag)}?sort=${option.value}`}
      ...
      {stories && stories.length > 0 ? (
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex gap-2 mt-2 flex-wrap">
                  {story.genres?.slice(0, 3).map((g: string) => (
                    <span key={g} className="px-2 py-0.5 bg-zinc-100 dark:bg-zinc-800 rounded text-xs">
                      {g}
                    </span>
                  ))}
                </div>
        ...
        <div className="text-center py-12">
          ...
          <p className="text-zinc-500">No stories found with this tag yet.</p>
