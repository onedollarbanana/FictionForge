            ...
            {editingId === comment.id ? (
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <Button size="sm" onClick={() => handleSaveEdit(comment.id)} disabled={saving}>
              ...
              <>
                <div className={`text-sm whitespace-pre-wrap ${comment.isSpoiler ? 'bg-muted p-2 rounded blur-sm hover:blur-none transition-all cursor-pointer' : ''}`}>
                  {comment.content}
                </div>
